...
<div class="row" style="margin: 0 -6px;">
    <div class="col-md-5" style="padding: 0 6px;">
        <div class="ds-form-group">
            ...
            <input type="text" id="skbs_docnumb" class="form-control"
                   value="<?= htmlspecialchars(docnumb_value('SKBS', $skbs ? (isset($skbs->docnumb) ? $skbs->docnumb : '') : '')) ?>"
                   placeholder="00000/SKBS/IX/2026" maxlength="100" autocomplete="off">
